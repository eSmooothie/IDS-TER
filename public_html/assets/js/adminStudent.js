$(document).ready(function(){
  ...
  $(document).ajaxStart(function(){
    loading.modal('show');}).ajaxStop(function(){});
...
$("#addNewStudents").submit(function(e){
  ...
  var done=function(data){window.location.reload();};
  var fail=function(xhr,textStatus,errorMessage){window.location.reload();};
  $.ajax({type:'post',url:url,
  data:formData,cache:false,contentType:false,processData:false}).done(done).fail(fail);});
