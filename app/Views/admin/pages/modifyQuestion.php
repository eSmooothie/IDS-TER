...
<div class="w-full col-span-7 p-2 space-y-3">
    ...
    <div class="p-3 bg-gray-100 rounded-md mb-3">
        <form id="modifyQuestion" class="space-y-3">
            <div>
                <p class=" font-medium">Edit question</p>
            </div>
            <div class="">
                <label for="question" class="block">Question (<span class="font-medium"><?php echo "{$question['QUESTION']}";?></span>)</label>
                <input type="hidden" name="id" value="<?php echo "{$question['ID']}";?>">
                <input type="text" name="question" class="w-1/2" id="question" 
                placeholder="New question" required>
            </div>
            <div class="">
