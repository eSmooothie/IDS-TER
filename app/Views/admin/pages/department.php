            ...
            foreach ($department as $key => $value) {
              ...
              <tr class="bg-white border-b hover:bg-gray-200 odd:bg-white even:bg-gray-200">
                ...
                <td class="py-4 px-6 text-sm font-medium text-left whitespace-nowrap uppercase">
                  <a class="<?php echo (empty($chairperson))? "text-gray-400":"text-blue-600 hover:text-blue-900";?>" href="<?php echo (empty($chairperson))? "#":"$base_url/admin/teacher/view/{$chairperson['ID']}"; ?>">
                ...
                <td class="py-4 px-6 text-sm font-medium text-left whitespace-nowrap">
                  <a href="<?php echo "$base_url/admin/department/view/$id"; ?>" class="text-blue-600 hover:text-blue-900">View</a>
                </td>
              </tr>
              <?php
            }
